var app = angular.module("App", ['ngRoute', 'ui.bootstrap', 'pascalprecht.translate', 'ngAnimate', 'ngDraggable', 'chart.js', 'gridstack-angular','color.picker','hmTouchEvents', 'angularjs-gauge']);
